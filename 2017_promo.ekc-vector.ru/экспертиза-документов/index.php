    ...
    <div class="uk-grid tm-margin-top-35 tm-margin-bottom-35">
        <div class="uk-width-1-3 uk-text-left uk-vertical-align"><!-- Адрес -->
            <div class="uk-vertical-align-middle">
                <span class="uk-text-large">Цветной бульвар, 22с6</span><br>
...
<div class="uk-margin-top tm-header-border">
    <header class="uk-container uk-container-center">
        ...
        <p class="uk-text uk-text-contrast">
            Окажем помощь, если Вы сомневаетесь в подлиности документа или подписи в нем:<br>
            проведем экспертизу подписи (почерка) и <abbr title="технико-криминалистическую экспертизу документов">ТКЭД<sup>?</sup></abbr> как в досудебном, так и в судебном порядках.
        </p>
        <p class="uk-text uk-text-contrast">
            В результате Вы получите документ «Заключение специалиста»,<br>
            который сможете предоставить в компетентные органы для защиты своих прав и интересов.
        </p>
        <p class="uk-text uk-text-contrast">
            Вашей проблемой займется эксперт, имеющий опыт работы в МВД<br>
            и являющийся штатным сотрудником компании с десятилетней историей.
        </p>
    </header>
</div>
                ...
                <tbody class="uk-accordion" data-uk-accordion>
                    ...
                    <tr>
                        ...
                        <td class="uk-text-center uk-table-middle">
                            <span style="text-decoration:line-through">10 000</span><br>
                            <span class="uk-text-success">7 000</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="tm-td-border-right">
        ...
        <div class="uk-width-1-2"><!-- Контакты -->
            <div class="uk-panel uk-panel-box">
                ...
                <p class="uk-text">
                    ...
                    127051, гор. Москва, Цветной бульвар, д. 22, стр. 6, офис 10 
                </p>
                <p class="uk-text">
                    Телефон:<br>
