...
<head>
    ...
    <title>Экспертиза оружия - ЭКЦ «Вектор»</title>
...
<div class="uk-margin-top tm-header-border">
    <header class="uk-container uk-container-center">
        ...
        <p class="uk-text uk-text-contrast">
            Проводим экспертизу холодного, огнестрельного оружия, боеприпасов и следов выстрела.<br>
    ...
    <div class="uk-grid uk-grid-small">
        ...
        <div class="uk-width-1-3"><!-- Инструменты -->
            <div class="uk-panel uk-panel-box uk-text-center tm-margin-top-55 tm-padding-top-35">
                ...
                <p class="uk-text-justify">
                    Помимо экспертов в штате и их опыта, у нас есть современное оборудование, позволяющее проводить исследования любой сложности и в короткие сроки.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="uk-width-1-2">
            ...
            <div class="uk-scrollable-box tm-scrollable-box">
                <ul class="uk-list uk-list-line">
                    ...
                    <li>
                        <p class="uk-text">
                            Свидетельство о праве на самостоятельное производство баллистической экспертизы <a class="tm-icon-link" href="../img/zagika/5.png" data-uk-lightbox="{group:'zagika'}"><i class="uk-icon-file-image-o"></i></a>
                        </p>
                    </li>
                    <li>
                        <p class="uk-text">
                            Свидетельство о праве на самостоятельное производство экспертизы холодного оружия <a class="tm-icon-link" href="../img/zagika/6.png" data-uk-lightbox="{group:'zagika'}"><i class="uk-icon-file-image-o"></i></a>
                        </p>
                    </li>
                    <li>
                        <p class="uk-text">
...
<div id="price" class="uk-container uk-container-center uk-margin-top tm-background-white tm-shadow"><!-- Стоимость услуг -->
    ...
    <p class="uk-text-justify">
        Расположенная ниже таблица поможет Вам более подробно ознакомиться с услугами, которые предоставляет ЭКЦ «Вектор», определить для себя вопросы, необходимые для решения Вашей задачи, узнать сроки и стоимость услуг наших специалистов. <span class="uk-text-danger">Представленный ниже список решаемых вопросов не является полным, звоните!</span>
    </p>
        ...
        <tbody class="uk-accordion" data-uk-accordion>
            <tr>
                <td class="tm-td-border-right">
                    Экспертиза холодного оружия:<br>
                    ...
                    <ul class="uk-list uk-text-muted uk-accordion-content tm-table-accordion-content">
                        <li><i class="uk-icon-question-circle"></i><span class="uk-text-bold"> Примеры вопросов:</span>
                            <ul class="uk-list">
                                <li>«Явлетеся ли предмет представленный на экспертизу холодным оружием?»</li>
                                <li>«К каком типу и виду относится представленное холодное оружие?»</li>
                                <li>«Каким способом изготовлено представленное на экспертизу оружие?»</li>
                            </ul>
                        </li>
            ...
            <tr>
                <td class="tm-td-border-right">
                    Экспертиза огнестрельного оружия:<br>
                    <span class="uk-accordion-title tm-table-accordion-title">Подробнее об услуге</span>
                    <ul class="uk-list uk-text-muted uk-accordion-content tm-table-accordion-content">
                        <li><i class="uk-icon-question-circle"></i><span class="uk-text-bold"> Примеры вопросов:</span>
                            <ul class="uk-list">
                                <li>«Является ли огнестрельным оружием предмет, представленный на исследование?»</li>
                                <li>«Каков вид (система, модель) оружия, представленного на исследование?»</li>
                                <li>«Является ли оружие технически исправным?»</li>
                                <li>«Частью оружия какого вида (системы, модели) является деталь, представленная на исследование?»</li>
                            </ul>
                        </li>
                        <li><i class="uk-icon-clock-o"></i><span class="uk-text-bold"> Cрок проведения:</span> от 1-х до 2-х рабочих дней</li>
                    </ul>
            ...
            <tr>
                <td class="tm-td-border-right">
                    Экспертиза боеприпасов и следов выстрела :<br>
                    <span class="uk-accordion-title tm-table-accordion-title">Подробнее об услуге</span>
                    <ul class="uk-list uk-text-muted uk-accordion-content tm-table-accordion-content">
                        <li><i class="uk-icon-question-circle"></i><span class="uk-text-bold"> Примеры вопросов:</span>
                            <ul class="uk-list">
                                <li>«К какому виду относятся представленные для исследования патроны; <br>для стрельбы из какого оружия они предназначены?»</li>
                                <li>«Пригодны ли представленные патроны для производства выстрелов?»</li>
                                <li>«Каково пробивное действие снарядов представленных патронов при стрельбе <br>из конкретного экземпляра оружия или оружия, для стрельбы из которого они предназначены?»</li>
                                <li>«Каким способом (заводским или самодельным) изготовлены представленные патроны?»</li>
                            </ul>
                        </li>
            ...
            <tr>
                <td class="tm-td-border-right">
                    Рецензирование (оспаривание) заключений:<br>
                    <span class="uk-accordion-title tm-table-accordion-title">Подробнее об услуге</span>
                    <ul class="uk-list uk-text-muted uk-accordion-content tm-table-accordion-content">
...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter49529074 = new Ya.Metrika2({
                    id:49529074,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/49529074" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
